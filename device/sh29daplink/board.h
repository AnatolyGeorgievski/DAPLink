...
#define BOARD_APB1_ENABLE	\
	( RCU_APB1EN_I2C0EN|RCU_APB1EN_PMUEN)
//| RCC_APB1ENR_TIM3EN | RCC_APB1ENR_TIM4EN | RCC_APB1ENR_TIM5EN | RCC_APB1ENR_TIM13EN
#define BOARD_APB2_ENABLE	\
	(RCU_APB2EN_AFEN|RCU_APB2EN_PAEN| RCU_APB2EN_PBEN|RCU_APB2EN_PCEN|RCU_APB2EN_ADC0EN|\
	 RCU_APB2EN_USART0EN)
 //RCC_APB2ENR_SPI1EN
...
/* PB5 INT прерывание на линии I2C */
...
/*	PB4, PA15 - кнопки 
	PA9..PA10, PB1..PB2, PC13..PC15 - входные сигналы */
#define BOARD_BUTTON_PIN {0x16,GPIOB, PIO_INPUT_PULLUP}, \
						{(1<<13)|(1<<14)|(1<<15),GPIOC, PIO_INPUT_PULLUP}, \
						{(1<<9)|(1<<10)|(1<<15),GPIOA, PIO_INPUT_PULLUP}
						
#define BOARD_SW_PIN	{0x11,GPIOA, PIO_OUTPUT_1}, \
						{0x0A,GPIOA, PIO_INPUT}
/* 	PB10..PB15 -- выбор индикатора: 0 - включить, 1 - выключить
	PA0..PA7 -- сегмент:0 - зажечь, 1 - выключить */
#define BOARD_LED_PINS  {0xFC00, GPIOB, PIO_OUTPUT_LOW_SPEED|PIO_SET|PIO_OPENDRAIN}, \
						{0x00FF, GPIOA, PIO_OUTPUT_LOW_SPEED|PIO_SET|PIO_OPENDRAIN}
...
#define BOARD_ALL_PINS	BOARD_SWO_PIN, BOARD_USBD_PINS, BOARD_I2C_PIN, BOARD_USART0_PIN
//BOARD_USART1_PIN, BOARD_BUTTON_PIN, BOARD_ADC1_PIN
...
#define PIN_RESET GPIOB, (1U<<PIN_RESET_POS)
#define PIN_LED_RUN GPIOC, (1<<6)