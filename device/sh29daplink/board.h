...
#define BOARD_ALL_PINS	BOARD_SWO_PIN, BOARD_USBD_PINS, BOARD_I2C_PIN, BOARD_USART0_PIN, BOARD_SIGNAL_PIN, BOARD_BUTTON_PIN
//BOARD_USART1_PIN, BOARD_ADC1_PIN
